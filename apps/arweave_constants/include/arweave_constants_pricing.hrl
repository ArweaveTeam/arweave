...
% 0.995, i.e., 0.5% annual decay rate.
-define(PRICE_DECAY_ANNUAL, {995, 1000}).
...
-define(INITIAL_USD_TO_AR_HEIGHT(Height), fun() ->
    ...
    case Forks of
        ...
        {Fork_1_9, _Fork_2_2, _Fork_2_5, _Fork_2_6} when Height < Fork_1_9 ->
            max(arweave_constants:height_1_8(), 1);
...
% 0.001045
-define(USD_PER_GBY_2018, {1045, 1000000}).
...
% 0.000925
-define(USD_PER_GBY_2019, {925, 1000000}).
