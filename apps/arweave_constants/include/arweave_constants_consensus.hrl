...
% 90% of 4 TB.
-define(MAINNET_PARTITION_SIZE, 3_600_000_000_000).
...
-else.
% == 25 * 1024 * 1024
-define(RECALL_RANGE_SIZE, 26_214_400).
-endif.
...
-else.
% == 100 * 1024 * 1024
-define(LEGACY_RECALL_RANGE_SIZE, 104_857_600).
-endif.
...
-define(SPORA_MIN_DIFFICULTY(Height),
    fun() ->
        Forks = {
