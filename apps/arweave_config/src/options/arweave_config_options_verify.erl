...
force_verify_flags() ->
    ...
    io:format("~n  - [sync, max_download_rate] 0"),
    io:format("~n  - [gossip, block, pollers] 0"),
    io:format("~n  - [gossip, header, workers] 0"),
    ...
    _ = arweave_config:set([sync, max_download_rate], 0),
    _ = arweave_config:set([gossip, block, pollers], 0),
    _ = arweave_config:set([gossip, header, workers], 0),
