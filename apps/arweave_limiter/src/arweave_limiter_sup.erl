    ...
    [
     #{id => chunk,
       ...
       timestamp_cleanup_tick_ms =>
           Config#config.'http_api_limiter.chunk.sliding_window_timestamp_cleanup_interval',
       timestamp_cleanup_expiry =>
           Config#config.'http_api_limiter.chunk.sliding_window_timestamp_cleanup_expiry',
       leaky_rate_limit => Config#config.'http_api.limiter.chunk.leaky_limit',
       leaky_tick_ms => Config#config.'http_api.limiter.chunk.leaky_tick_intercal',
       concurrency_limit => Config#config.'http_api.limiter.chunk.concurrency_limit',
       is_manual_reduction_disabled => 'http_api.limiter.chunk.is_manual_reduction_disabled'},
     ...
     #{id => data_sync_record,
       ...
       timestamp_cleanup_tick_ms =>
           Config#config.'http_api_limiter.data_sync_record.sliding_window_timestamp_cleanup_interval',
       timestamp_cleanup_expiry =>
           Config#config.'http_api_limiter.data_sync_record.sliding_window_timestamp_cleanup_expiry',
       leaky_rate_limit => Config#config.'http_api.limiter.data_sync_record.leaky_limit',
       leaky_tick_ms => Config#config.'http_api.limiter.data_sync_record.leaky_tick_intercal',
       concurrency_limit => Config#config.'http_api.limiter.data_sync_record.concurrency_limit',
       is_manual_reduction_disabled => 'http_api.limiter.data_sync_record.is_manual_reduction_disabled'},
     ...
     #{id => recent_hash_list_diff,
       ...
       timestamp_cleanup_tick_ms =>
           Config#config.'http_api_limiter.recent_hash_list_diff.sliding_window_timestamp_cleanup_interval',
       timestamp_cleanup_expiry =>
           Config#config.'http_api_limiter.recent_hash_list_diff.sliding_window_timestamp_cleanup_expiry',
       leaky_rate_limit => Config#config.'http_api.limiter.recent_hash_list_diff.leaky_limit',
       leaky_tick_ms => Config#config.'http_api.limiter.recent_hash_list_diff.leaky_tick_intercal',
       concurrency_limit => Config#config.'http_api.limiter.recent_hash_list_diff.concurrency_limit',
       is_manual_reduction_disabled => 'http_api.limiter.recent_hash_list_diff.is_manual_reduction_disabled'},
     ...
     #{id => block_index,
       ...
       timestamp_cleanup_tick_ms =>
           Config#config.'http_api_limiter.block_index.sliding_window_timestamp_cleanup_interval',
       timestamp_cleanup_expiry =>
           Config#config.'http_api_limiter.block_index.sliding_window_timestamp_cleanup_expiry',
       leaky_rate_limit => Config#config.'http_api.limiter.block_index.leaky_limit',
       leaky_tick_ms => Config#config.'http_api.limiter.block_index.leaky_tick_intercal',
       concurrency_limit => Config#config.'http_api.limiter.block_index.concurrency_limit',
       is_manual_reduction_disabled => 'http_api.limiter.block_index.is_manual_reduction_disabled'},
     ...
     #{id => wallet_list,
       ...
       timestamp_cleanup_tick_ms =>
           Config#config.'http_api_limiter.wallet_list.sliding_window_timestamp_cleanup_interval',
       timestamp_cleanup_expiry =>
           Config#config.'http_api_limiter.wallet_list.sliding_window_timestamp_cleanup_expiry',
       leaky_rate_limit => Config#config.'http_api.limiter.wallet_list.leaky_limit',
       leaky_tick_ms => Config#config.'http_api.limiter.wallet_list.leaky_tick_intercal',
       concurrency_limit => Config#config.'http_api.limiter.wallet_list.concurrency_limit',
       is_manual_reduction_disabled => 'http_api.limiter.wallet_list.is_manual_reduction_disabled'},
     ...
     #{id => get_vdf,
       ...
       timestamp_cleanup_tick_ms =>
           Config#config.'http_api_limiter.get_vdf.sliding_window_timestamp_cleanup_interval',
       timestamp_cleanup_expiry =>
           Config#config.'http_api_limiter.get_vdf.sliding_window_timestamp_cleanup_expiry',
       leaky_rate_limit => Config#config.'http_api.limiter.get_vdf.leaky_limit',
       leaky_tick_ms => Config#config.'http_api.limiter.get_vdf.leaky_tick_intercal',
       concurrency_limit => Config#config.'http_api.limiter.get_vdf.concurrency_limit',
       is_manual_reduction_disabled => 'http_api.limiter.get_vdf.is_manual_reduction_disabled'},
     ...
     #{id => get_vdf_session,
       ...
       timestamp_cleanup_tick_ms =>
           Config#config.'http_api_limiter.get_vdf_session.sliding_window_timestamp_cleanup_interval',
       timestamp_cleanup_expiry =>
           Config#config.'http_api_limiter.get_vdf_session.sliding_window_timestamp_cleanup_expiry',
       leaky_rate_limit => Config#config.'http_api.limiter.get_vdf_session.leaky_limit',
       leaky_tick_ms => Config#config.'http_api.limiter.get_vdf_session.leaky_tick_intercal',
       concurrency_limit => Config#config.'http_api.limiter.get_vdf_session.concurrency_limit',
       is_manual_reduction_disabled => 'http_api.limiter.get_vdf_session.is_manual_reduction_disabled'},
     ...
     #{id => get_previous_vdf_session,
       ...
       timestamp_cleanup_tick_ms =>
           Config#config.'http_api_limiter.get_previous_vdf_session.sliding_window_timestamp_cleanup_interval',
       timestamp_cleanup_expiry =>
           Config#config.'http_api_limiter.get_previous_vdf_session.sliding_window_timestamp_cleanup_expiry',
       leaky_rate_limit => Config#config.'http_api.limiter.get_previous_vdf_session.leaky_limit',
       leaky_tick_ms => Config#config.'http_api.limiter.get_previous_vdf_session.leaky_tick_intercal',
       concurrency_limit => Config#config.'http_api.limiter.get_previous_vdf_session.concurrency_limit',
       is_manual_reduction_disabled => 'http_api.limiter.get_previous_vdf_session.is_manual_reduction_disabled'},
     ...
     #{id => general,
       ...
       timestamp_cleanup_expiry =>
           Config#config.'http_api_limiter.general.sliding_window_timestamp_cleanup_expiry',
     ...
     #{id => metrics,
       ...
       timestamp_cleanup_tick_ms =>
           Config#config.'http_api_limiter.metrics.sliding_window_timestamp_cleanup_interval',
       timestamp_cleanup_expiry =>
           Config#config.'http_api_limiter.metrics.sliding_window_timestamp_cleanup_expiry',
       leaky_rate_limit => Config#config.'http_api.limiter.metrics.leaky_limit',
       leaky_tick_ms => Config#config.'http_api.limiter.metrics.leaky_tick_intercal',
       concurrency_limit => Config#config.'http_api.limiter.metrics.concurrency_limit',
       is_manual_reduction_disabled => 'http_api.limiter.metrics.is_manual_reduction_disabled'},
     %% Local peers
     #{id => local_peers,
       no_limit => true}
    ].
