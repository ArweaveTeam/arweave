...
get_limiter_config() ->
    ...
    [
     #{id => chunk,
       ...
       tick_reduction => Config#config.'http_api.limiter.chunk.leaky_tick_intercal',
     ...
     #{id => data_sync_record,
       ...
       tick_reduction => Config#config.'http_api.limiter.data_sync_record.leaky_tick_intercal',
     ...
     #{id => recent_hash_list_diff,
       ...
       tick_reduction => Config#config.'http_api.limiter.recent_hash_list_diff.leaky_tick_intercal',
     ...
     #{id => block_index,
       ...
       tick_reduction => Config#config.'http_api.limiter.block_index.leaky_tick_intercal',
     ...
     #{id => wallet_list,
       ...
       tick_reduction => Config#config.'http_api.limiter.wallet_list.leaky_tick_intercal',
     ...
     #{id => get_vdf,
       ...
       tick_reduction => Config#config.'http_api.limiter.get_vdf.leaky_tick_intercal',
     ...
     #{id => get_vdf_session,
       ...
       tick_reduction => Config#config.'http_api.limiter.get_vdf_session.leaky_tick_intercal',
     ...
     #{id => get_previous_vdf_session,
       ...
       tick_reduction => Config#config.'http_api.limiter.get_previous_vdf_session.leaky_tick_intercal',
     ...
     #{id => general,
       ...
       tick_reduction => Config#config.'http_api.limiter.general.leaky_tick_intercal',
     ...
     #{id => metrics,
       ...
       tick_reduction => Config#config.'http_api.limiter.metrics.leaky_tick_intercal',
