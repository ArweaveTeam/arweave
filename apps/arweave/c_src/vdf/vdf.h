...
static inline void long_add(unsigned char* saltBuffer, unsigned int checkpointIdx) {
...
bool vdf_parallel_sha_verify_with_reset(unsigned char* startSaltBuffer, unsigned char* seed, unsigned int checkpointCount, unsigned int skipCheckpointCount, unsigned int hashingIterations, unsigned char* inRes, unsigned char* inCheckpoint, unsigned char* outCheckpoint, unsigned char* resetSalt, unsigned char* resetSeed, int maxThreadCount);
