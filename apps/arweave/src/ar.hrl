...
%% Base wallet generation fee in USD. The amount in AR depends on the
%% current difficulty and height. See ar_tx:calculate_wallet_fee/2.
-define(WALLET_GEN_FEE_USD, 0.1).
