...
get(ID, StoreID) ->
	...
	case catch gen_server:call(GenServerID, {get, ID}, 10000) of
...
get(ID, Type, StoreID) ->
	GenServerID = list_to_atom("ar_sync_record_" ++ StoreID),
	case catch gen_server:call(GenServerID, {get, Type, ID}, 10000) of
		{'EXIT', {timeout, {gen_server, call, _}}} ->
			{error, timeout};
		Reply ->
			Reply
...
add(End, Start, ID, StoreID) ->
	GenServerID = list_to_atom("ar_sync_record_" ++ StoreID),
	case catch gen_server:call(GenServerID, {add, End, Start, ID}, 10000) of
		{'EXIT', {timeout, {gen_server, call, _}}} ->
			{error, timeout};
		Reply ->
			Reply
...
add(End, Start, Type, ID, StoreID) ->
	GenServerID = list_to_atom("ar_sync_record_" ++ StoreID),
	case catch gen_server:call(GenServerID, {add, End, Start, Type, ID}, 10000) of
		{'EXIT', {timeout, {gen_server, call, _}}} ->
			{error, timeout};
		Reply ->
			Reply
...
delete(End, Start, ID, StoreID) ->
	GenServerID = list_to_atom("ar_sync_record_" ++ StoreID),
	case catch gen_server:call(GenServerID, {delete, End, Start, ID}, 10000) of
		{'EXIT', {timeout, {gen_server, call, _}}} ->
			{error, timeout};
		Reply ->
			Reply
...
cut(Offset, ID, StoreID) ->
	GenServerID = list_to_atom("ar_sync_record_" ++ StoreID),
	case catch gen_server:call(GenServerID, {cut, Offset, ID}, 10000) of
		{'EXIT', {timeout, {gen_server, call, _}}} ->
			{error, timeout};
		Reply ->
			Reply
...
init(StoreID) ->
	...
	Dir =
		case StoreID of
			...
			_ ->
				filename:join([StoreID, ?ROCKS_DB_DIR, "ar_sync_record_db"])
		end,
