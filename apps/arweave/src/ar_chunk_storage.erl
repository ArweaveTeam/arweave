...
write_chunk(PaddedOffset, Chunk, FileIndex, StoreID) ->
	...
	case get_handle_by_filepath(Filepath) of
		{error, _} = Error ->
			Error;
		F ->
			write_chunk2(PaddedOffset, ChunkOffset, Chunk, Filepath, F, Position, StoreID)
	end.
...
write_chunk2(_PaddedOffset, ChunkOffset, Chunk, Filepath, F, Position, StoreID) ->
	?LOG_DEBUG([{event, write_chunk2}, {store_id, StoreID}, {filepath, Filepath},
