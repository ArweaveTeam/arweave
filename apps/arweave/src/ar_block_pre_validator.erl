...
pre_validate_nonce_limiter_global_step_number(B, PrevB, SolutionResigned, Peer) ->
	...
	ExpectedStepCount = get_expected_step_count(Steps, StepNumber, PrevStepNumber, MaxDistance),
...
-ifdef(LOCALNET).
get_expected_step_count(Steps, StepNumber, PrevStepNumber, MaxDistance) ->
