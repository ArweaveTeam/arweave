...
log_price_metrics(Event,
	...
	ar_metrics:gauge_set(poa_count, [1], OneChunkCount),
	ar_metrics:gauge_set(poa_count, [2], TwoChunkCount),
	ar_metrics:gauge_set(v2_price_per_gibibyte_minute, PricePerGiBPerMinute),
	ar_metrics:gauge_set(network_data_size, EstimatedDataSizeInBytes),
