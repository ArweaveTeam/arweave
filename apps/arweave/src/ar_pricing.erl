...
log_price_metrics(Event,
	...
	arweave_metrics:gauge_set(poa_count, [1], OneChunkCount),
	arweave_metrics:gauge_set(poa_count, [2], TwoChunkCount),
	arweave_metrics:gauge_set(v2_price_per_gibibyte_minute, PricePerGiBPerMinute),
	arweave_metrics:gauge_set(network_data_size, EstimatedDataSizeInBytes),
