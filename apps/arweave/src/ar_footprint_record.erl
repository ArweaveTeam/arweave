...
add(Offset, Packing, StoreID) ->
	...
	FootprintOffset = get_offset(PaddedOffset),
...
-spec add_async(Tag :: term(), PaddedOffset :: non_neg_integer(), Packing :: term(), StoreID :: string()) -> ok.
add_async(Tag, PaddedOffset, Packing, StoreID) ->
