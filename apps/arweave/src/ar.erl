...
parse_cli_args(["start_from_state", Folder | Rest], C) ->
	parse_cli_args(Rest, C#config{ start_from_state = Folder });
...
parse_cli_args(["replica_2_9_entropy_cache_size_mb", Num | Rest], C) ->
	parse_cli_args(Rest, C#config{ replica_2_9_entropy_cache_size_mb = list_to_integer(Num) });
