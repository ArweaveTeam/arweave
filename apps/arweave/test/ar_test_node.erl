...
http_get_block(H, NodePrefix) ->
	{ok, Config} = remote_call(NodePrefix, application, get_env, [arweave, config]),
...
get_blocks(NodePrefix) ->
	remote_call(NodePrefix, ar_node, get_blocks, []).
