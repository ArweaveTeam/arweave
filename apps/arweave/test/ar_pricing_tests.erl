...
test_auto_redenomination_and_endowment_debt() ->
	...
	assert_wait_until_height(peer1, 6),
	...
	assert_wait_until_height(peer1, 7),
	...
	assert_wait_until_height(peer1, 8),
	...
	assert_wait_until_height(peer1, 9),
	...
	assert_wait_until_height(peer1, 11),
	...
	assert_wait_until_height(peer1, 12),
	...
	assert_wait_until_height(peer1, 13),
	...
	assert_wait_until_height(peer1, 14),
