...
test_auto_redenomination_and_endowment_debt() ->
	...
	?assert(B6#block.reward =< HalfKryderLatchReset
			* MinerShareDividend div MinerShareDivisor),
	...
	?assertEqual(0, B7#block.kryder_plus_rate_multiplier_latch),
	...
	FeeCap13 = BaseReward13 div ?MINER_FEE_SHARE_CAP,
	FeeSum13 =
		min(BaseReward13,
			min(FeeCap13, Reward14 * MinerShareDividend div MinerShareDivisor) % TX12
			+ min(FeeCap13, Reward14 * MinerShareDividend div MinerShareDivisor) % TX13
			+ min(FeeCap13, Reward14 * MinerShareDividend div MinerShareDivisor) % TX14
			+ min(FeeCap13, Reward17_2 * MinerShareDividend div MinerShareDivisor)), % TX17
	?assert(10 * 1000 + FeeSum13 < BaseReward13),
	?assertEqual(B12#block.reward_pool + Reward14 * 3 + Reward17_2 - FeeSum13
			- (BaseReward13 - (10 * 1000 + FeeSum13)), B13#block.reward_pool),
