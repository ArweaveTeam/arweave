...
joins_network_successfully() ->
	...
	TX3 = ar_test_node:sign_tx(Key, #{ last_tx => element(1, lists:nth(?MAX_TX_ANCHOR_DEPTH - 1, BI)) }),
	ar_test_node:assert_post_tx_to_peer(peer1, TX3),
	ar_test_node:mine(peer1),
	...
	%% lists:nth(?MAX_TX_ANCHOR_DEPTH - 1, BI2) since we're now at ?MAX_TX_ANCHOR_DEPTH + 2.
