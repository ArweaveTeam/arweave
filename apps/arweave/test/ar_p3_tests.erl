...
ar_p3_test_() ->
	[
		...
		{timeout, 100, fun test_not_found/0},
		{timeout, 100, fun test_bad_headers/0},
		{timeout, 100, fun test_valid_request/0},
		{timeout, 100, fun test_zero_rate/0},
		{timeout, 100, fun test_checksum_request/0},
		{timeout, 100, fun test_bad_config/0},
		{timeout, 100, fun test_balance_endpoint/0},
		{timeout, 100, fun test_reverse_charge/0},
